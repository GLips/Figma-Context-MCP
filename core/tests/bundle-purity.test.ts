...
//
// This complements the Figma-free gate (figma-free.test.ts): that one
...
describe("simplify core is bundle-pure (Invariant 4)", () => {
  it("bundles under platform:'neutral' entirely from this package — no builtins, no packages", async () => {
    ...
    // property: every module in the core bundle comes from this package's own src/.
