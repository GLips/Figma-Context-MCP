...
export { frame, text, rect, ellipse, line, svg, path, render, gradient, image, effects, get, find, findOne, selection, id, edit, append, prepend, insertBefore, insertAfter };
...
const _flcmSurface = { frame, text, rect, ellipse, line, svg, path, render, gradient, image, effects, get, find, findOne, selection, id, edit, append, prepend, insertBefore, insertAfter } satisfies Flcm;
void _flcmSurface;
